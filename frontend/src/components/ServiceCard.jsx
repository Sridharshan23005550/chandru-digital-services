...
const ServiceCard = ({ icon: Icon, title, description, image, delay = 0 }) => {
    return (
        <motion.div
            ...
            className="group relative rounded-3xl overflow-hidden bg-dark-800 border border-white/5 hover:border-primary/30 transition-colors"
        >
